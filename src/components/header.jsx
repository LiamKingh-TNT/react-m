        ...
        <div className="flex items-center justify-center md:justify-between">
          <div  className="flex items-center justify-center md:ml-16">
            ...
            <nav className="hidden md:flex gap-8 text-white text-[20px] font-semibold ">
              <Link to="/products/id/0" className="nav-underline-center">Background Story</Link>
              <Link to="/products/id/1" className="nav-underline-center">Game Component</Link>
              <Link to="/products/id/2" className="nav-underline-center">Game Rules</Link>
            </nav>
          </div>
        </div>
      </header>
