    ...
    return (
        <footer id='bottom' className="footer relative z-50 w-full min-h-screen text-[#C4C4C4] flex flex-col items-center gap-15 md:justify-between">
          ...
          <div className="flex items-center gap-8 text-white text-sm font-semibold">
            <img src="/images/phone-receiver-silhouette.png" className="w-[6vw] h-auto md:w-[3vw]"/>
            <p className="text-[#C4C4C4]  text-[4vw] md:text-[1.5vw] ">(03)7660-4512  (This is Fake)</p>
          </div>
          <div className="flex items-center gap-8 text-white text-sm font-semibold">
            <img src="/images/email.png" className="w-[6vw] h-auto md:w-[3vw]"/>
            <p className="text-[#C4C4C4] text-[4vw] md:text-[1.5vw]">TheThroneofDelusion@gmail.com</p>
          </div>
